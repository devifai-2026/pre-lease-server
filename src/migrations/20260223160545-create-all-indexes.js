...
CREATE INDEX IF NOT EXISTS idx_property_manager_notes_created_by ON property_manager_notes(created_by) WHERE created_by IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_property_manager_notes_is_edited ON property_manager_notes(is_edited) WHERE is_edited = true;
